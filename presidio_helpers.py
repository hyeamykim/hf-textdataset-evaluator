...
def batch_analyzer_engine(
    ...
    analyzer = BatchAnalyzerEngine(analyzer_engine=AnalyzerEngine(nlp_engine=nlp_engine, registry=registry))
    return analyzer
...
def batch_analyze(
    ...
    return batch_analyzer_engine(model_family, model_path, ta_key, ta_endpoint).analyze_iterator(
        **kwargs
    )
...
#     res = batch_anonymizer_engine().anonymize_iterator(
#         texts,
#         analyze_results,
#         operators={"DEFAULT": OperatorConfig(operator, operator_config)},
#     )
